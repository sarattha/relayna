...
class RelaynaRabbitClient:
    ...
    async def ensure_workflow_queue(self, stage: str) -> str:
        ...
        return await self._topology.ensure_workflow_queue(
            self._channel, workflow_exchange=self._workflow_exchange, stage=stage
        )
    ...
    async def publish_task(
        self, task: BaseModel | Mapping[str, Any], *, headers: Mapping[str, Any] | None = None
    ) -> None:
    ...
    async def publish_workflow(
        self, payload: WorkflowEnvelope | Mapping[str, Any], *, headers: Mapping[str, Any] | None = None
    ) -> None:
    ...
    def _resolve_batch_priority(self, tasks: Sequence[Mapping[str, Any]]) -> int | None:
        ...
        self._validate_priority_against_limit(priority, max_priority=self._resolved_task_max_priority(), kind="task")
        return priority
