...
description: Use before adding features or changing public SDK, Studio backend, Studio frontend API/type, route, schema, configuration, persisted data, or wire behavior after the Relayna production freeze. Enforces the strict v1.4.27 freeze perimeter and manifest update rules.
---
...
Relayna `v1.4.27` is the production freeze boundary. Use this skill before
